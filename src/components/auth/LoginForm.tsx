...
export const LoginForm = () => {
  ...
  const inputThemeClasses = "bg-gray-100 text-gray-900 placeholder:text-gray-500 focus:ring-2 focus:ring-[#0061FE] focus:border-[#0061FE] dark:bg-[#1e293b] dark:text-white dark:placeholder:text-gray-400 dark:focus:ring-[#0061FE]/50 dark:focus:border-[#0061FE]";

  // Botão Primário
  const primaryButtonClasses = 'bg-[#0061FE] hover:bg-[#0054DA] text-white'; // Nova cor primária
  ...
  return (
    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
      ...
      <Button
        type="submit"
        className={cn(
          "h-16 px-6 text-xl font-bold transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0061FE] rounded-xl",
